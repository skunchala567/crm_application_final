    ...
    <div className="filter-workspace-body">
      ...
      <main className="filter-fields"><div className="field-search"><Search/><input value={fieldSearch} onChange={event => setFieldSearch(event.target.value)} placeholder="Search filter fields"/></div>
        {activeSection === "lead" && <div className="filter-grid">
          ...
          {/* Both read the lead's own record: the application payment taken on
              the enquiry form, and whether a student ID has been issued. */}
          <Field label="Payment status" searchText={fieldSearch}><MultiSearchSelect label="Payment status" value={filters.paymentStatus} onChange={value => set("paymentStatus",value)} options={[{value:"yes",label:"Paid"},{value:"no",label:"Not paid"},{value:"order_created",label:"Order created"},{value:"unpaid",label:"Unpaid"},{value:"expired",label:"Expired"},{value:"failed",label:"Failed"}]}/></Field>
          <Field label="Student ID generated" searchText={fieldSearch}><MultiSearchSelect label="Student ID generated" value={filters.studentIdStatus} onChange={value => set("studentIdStatus",value)} options={[{value:"yes",label:"Generated"},{value:"no",label:"Not generated"}]}/></Field>
