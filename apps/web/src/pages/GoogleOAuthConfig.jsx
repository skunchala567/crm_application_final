...
export default function GoogleOAuthConfig({ integrationId, onConfigSaved }) {
  ...
  return <section className="google-oauth-config">
    ...
    <style>{`
      ...
      .oauth-config-notice{margin-top:12px;padding:10px;display:flex;align-items:center;gap:7px;border-radius:7px;font-size:10px}.oauth-config-notice svg{width:16px}.oauth-config-notice.success{background:#e8f6f0;color:#258268}.oauth-config-notice.error{background:#fff0f0;color:#b23d3d}
