...
export default function GoogleOAuthConfig({ integrationId, onConfigSaved }) {
  ...
  return <section className="google-oauth-config">
    ...
    <style>{`
      ...
      .oauth-config-notice{margin-top:12px;padding:10px;display:flex;align-items:center;gap:7px;border-radius:7px;font-size:10px}.oauth-config-notice svg{width:16px}.oauth-config-notice.success{background:var(--ink-100);color:var(--brand-600)}.oauth-config-notice.error{background:#fdeeed;color:#b23d3d}
